# ============================================================
# Liver Gene Expression Analysis - Fig_4b
...
# 3) Define liver genes for Fig_4b
genes_fig4b <- c("Tbc1d4", "Glut1", "Zfand6", "Tcf19", "Ghrhr")
...
dat_raw$Gene <- factor(dat_raw$Gene, levels = genes_fig4b)

cat("Total observations (raw):", nrow(dat_raw), "\n")
cat("Genes:", paste(genes_fig4b, collapse = ", "), "\n")
...
ggsave(
  filename = "Fig_4b_FoldChange_Liver_GeneExpr.png",
  plot = plot_fig4b,
...
ggsave(
  filename = "Fig_4b_FoldChange_Liver_GeneExpr.svg",
  plot = plot_fig4b,
  scale = 1, width = 9.5, height = 6,
...
write.csv(
  posthoc_result,
  file = "Fig_4b_Posthoc_FoldChange_BH_corrected.csv",
  row.names = FALSE
)
...
write.csv(
  summary_stats,
  file = "Fig_4b_Summary_FoldChange_Liver_GeneExpr.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  file = "Fig_4b_FoldChange_Data.csv",
  row.names = FALSE
)
...
# ============================================================
cat("\n", rep("=", 70), "\n", sep = "")
cat("ANALYSIS COMPLETE - LIVER GENES (FOLD CHANGE)\n")
cat(rep("=", 70), "\n", sep = "")

cat("\nGenerated files:\n")
cat("  Figures:\n")
cat("    - Fig_4b_FoldChange_Liver_GeneExpr.png (600 dpi, 9.5×6 cm)\n")
cat("    - Fig_4b_FoldChange_Liver_GeneExpr.svg (vector format)\n")
cat("  Data tables:\n")
cat("    - Fig_4b_Posthoc_FoldChange_BH_corrected.csv\n")
cat("    - Fig_4b_Summary_FoldChange_Liver_GeneExpr.csv\n")
cat("    - Fig_4b_FoldChange_Data.csv\n")
...
cat("\nGenes analysed:\n")
cat("  ", paste(genes_fig4b, collapse = ", "), "\n")
cat(rep("=", 70), "\n", sep = "")
